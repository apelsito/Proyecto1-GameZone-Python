...
class MenuPrincipal: 
   ...
   / \     / \    ██   ███ ███████ ██ ████ ██ █████         ███   ██    ██ ██ ██  ██ █████       / \     / \
    ...
    def jeancha(self):
        """
        Posiblemente la mejor puta función que voy a crear en toda mi vida, me da pena no poder ponerla más grande (eso dijo ella)
        Esta función es la polla
        
        Bueno el caso, que he puesto la foto de Jeancha en Masterchef y la he pasado a ASCII, y ha quedado genial.
        Las más grande se ve genial
